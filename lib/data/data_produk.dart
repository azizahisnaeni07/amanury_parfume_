...
''',
  ...
  Produk(
    nama: 'Lakshya',
    deskripsi: 'Cocok untuk pria yang ingin tampil berkelas,modern,dan berkarakter,tanpa aroma yang terlalu berat atau tua',
    deskripsiLengkap: '''
...
''',
  ...
  Produk(
    nama: 'Annisha',
    deskripsi: 'Parfum ini memiliki karakteristik manis, floral, dan hangat, yang memancarkan sisi feminin, romantis, dan elegan',
    deskripsiLengkap: '''
...
''',
  ...
  Produk(
    nama: 'Kavisha',
    deskripsi: 'Parfume yang cocok untuk pribadi tenang, elegan, cerdas, dan intuitif',
    deskripsiLengkap: '''
...
• Hangat & creamy di akhir memberikan kesan mendalam dan meikat
